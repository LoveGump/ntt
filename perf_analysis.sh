...
do
echo "" >> perf_results / summary.txt echo "## $name" >>
    perf_results / summary.txt grep - A 5 "Performance counter stats"
                                          "perf_results/${name}_stat.txt" >>
    perf_results / summary.txt done
